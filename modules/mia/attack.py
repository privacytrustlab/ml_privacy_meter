        ...
        if args["attack"] == "RMIA":
            if args.get("offline_a") is None:
                ...
                if reuse_offline_a and serialized_key in self.configs:
                    ...
                    offline_a, _, _ = tune_offline_a(target_model_idx, all_signals, all_memberships, ref_signals, ref_memberships, z_target_signals, z_ref_signals, logger)
            ...
            mia_scores = run_rmia(target_signals, ref_signals, ref_memberships, z_target_signals, z_ref_signals, offline_a)
        else:
