...
python main.py --cf attack_configs/cifar100/lira_online_2_ref_models.yaml
python main.py --cf attack_configs/cifar100/rmia_online_2_ref_models.yaml

# plotting using matplotlib
python plot.py --log_dir "demo_cifar100"