...
do
    ...
    python main.py --cf "attack_configs/${dataset}/lira_online_254_ref_models.yaml" --audit.target_idx "${target_idx}"
    python main.py --cf "attack_configs/${dataset}/rmia_online_254_ref_models.yaml" --audit.target_idx "${target_idx}"
done
