...
setup(
      ...
      license="MIT",
      package_dir={
          'ml_privacy_meter': 'ml_privacy_meter',
          'ml_privacy_meter.attack': 'ml_privacy_meter/attack',
          'ml_privacy_meter.utils': 'ml_privacy_meter/utils',
      },
      packages=['ml_privacy_meter',
                'ml_privacy_meter.attack',
                'ml_privacy_meter.utils'],
