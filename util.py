...
def get_optimizer(model, configs):
    ...
    if configs['optimizer'] == 'SGD':
        ...
        raise NotImplementedError(
            f"Optimizer {configs['optimizer']}  has not been implemented. Please choose from SGD or Adam")
...
def get_split(all_index, used_index, size, split_method):
    ...
    if split_method == 'no_overlapping':
        ...
        raise NotImplementedError(
            f"{split_method} is not implemented. We only support uniform and no_overlapping.")
